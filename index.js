...
(async () => {
    ...
    result.map((value, index) => {
        console.log(`Q${index + 1}: ${value.question} - ${value.option ? chalk.green("Correct") : chalk.red("Incorrect! " + `The correct answer is ${chalk.yellowBright(correctAnswers[index])}`)}`);
    });
})();
